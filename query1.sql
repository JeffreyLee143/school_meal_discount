...
CREATE TABLE `order_histories`(
    ...
    `product_name` VARCHAR(310) ,
    `product_number` VARCHAR(310) ,
    `total_cost` INT ,
...
CREATE TABLE `discounts`(
 ...
 discount_content VARCHAR(50),
 discount_discount FLOAT
);
...
DELETE FROM `shops`
WHERE shop_id < 8;
INSERT INTO `discounts`(discount_content,discount_discount)VALUE('95折',0.95);
INSERT INTO `discounts`(discount_content,discount_discount)VALUE('9折',0.90);
INSERT INTO `discounts`(discount_content,discount_discount)VALUE('85折',0.85);
INSERT INTO `discounts`(discount_content,discount_discount)VALUE('8折',0.8);
ALTER TABLE `members` ADD member_point INT DEFAULT 0;
ALTER TABLE `members` DROP COLUMN member_point;
